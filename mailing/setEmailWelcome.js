const setEmailWelcome = (name, image) => {
                    ...
                    >
                      <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          >
                            Bienvenue !<br /><br />
                            Merci à vous d'avoir téléchargé notre application !<br />
                            Nous espérons que vous vous amuserez !<br />
                            N'oubliez pas d'être schwifty !
                            <br />
                            <br />
                            Cordialement,<br />
...
module.exports = setEmailWelcome;
